...
class ToysDataset(Dataset):
    def __init__(self, transform=None):
        ...
        """
        self.csv_path = "/scratch/ys6310/Mario/dataset/Toys/Toys.csv"
        self.images_folder = "/scratch/ys6310/Mario/dataset/Toys/ToysImages"
        ...
        self.prompt = "Question: Given the image and the text description of an item from the 'Toys & Games' category on Amazon, determine which of the following subcategories the item belongs to: "
        self.prompt += ", ".join(all_categories)
        self.image_processor = CLIPImageProcessor.from_pretrained("/scratch/ys6310/llava-1.5-7b-hf")
