...
class MoviesDataset(Dataset):
    def __init__(self, transform=None):
        ...
        """
        self.csv_path = "/scratch/ys6310/Mario/dataset/Movies/Movies.csv"
        self.images_folder = "/scratch/ys6310/Mario/dataset/Movies/MoviesImages"
        ...
        self.prompt = "\nQuestion: Given the image and the text description of an item from the 'Movies & TV' category on Amazon, determine which of the following subcategories the item belongs to: "
...
#     print("Train indices:", splits['train'])
#     print("Validation indices:", splits['val'])
#     print("Test indices:", splits['test'])
